            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="active" href="<spring:url value='/about_us'/>">About us </a></li>
	...
	<div id="support" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Rent A Roof</h3>
                <p class="lead">We like to think different and be different, but we combine that with our traditional and 
                	familiar practices of providing no nonsense, down to earth advice and service.  
                	We offer an advanced and innovative approach towards real estate and how to market and lease 
                	property using new and progressive marketing platforms and methods, particularly within the ever-expanding 
                	digital era of marketing and all that it has to offer.  
                	You can expect to see an enhanced array of marketing 'solutions', as our name would suggest.  
                	At Rent A Roof Real Estate Solutions we love talking about real estate and connecting with people 
                	from all walks of life.  
                	We would invite anyone to drop in, speak to our team and see what we are all about!</p>
            </div><!-- end title -->
        </div>
    </div>
