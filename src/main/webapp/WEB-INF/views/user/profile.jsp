...
<body class="realestate_version">
    ...
    <div class="about-box">
		<div class="container">
		    ...
		    <div class="row">
				<div class="col-md-6" style="height: 250px; width: 550px;">
						<!-- <div class="message-box right-ab"> -->
						<c:forEach var="v" items="${requestScope.docs_list}">
							<div class="row">
								<h3><a href="${pageContext.request.contextPath}${v.panCard}" target="_blank">View Pan Card</a></h3>
							</div>
							<div class="row">
								<h3><a href="${pageContext.request.contextPath}${v.aadhaarCard}" target="_blank">View Aadhaar Card</a></h3>
							</div>
						</c:forEach>
							<!-- <div class="row">
								<h3><a href="#" onclick="showDiv();">Click here to change your password</a></h3>
							</div> -->
	                    <!-- </div> -->
		        </div>
				<div class="col-md-6" style="height: 250px; width: 550px;">
				<!-- <div class="message-box right-ab">
	                <div id="support" class="section wb" style="display: none;">
				        <div class="container">
				            <div class="section-title text-center"> -->
				            <div style="text-align: center"><h2> Change Password</h2></div>
				        <div id="support" class="col-md-6 wow slideInLeft hidden-xs hidden-sm" style="height: 250px; width: 550px;">
                    		...
                    		<h3>${requestScope.response}</h3>
				                ...
				                <form:form id="contactform1" class="row" name="contactform" method="post">
				               			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="width:100%;">
				               				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="width:100%;">
					                            <input type="password" name="currPwd" id="currPwd" class="form-control" placeholder="Enter Current Password">
					                        </div>
				                			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="width:100%;">
