...
<body class="realestate_version">
                        ...
                        <c:choose>
							...
							<ul class="p-color-bg dropdown-menu tran3s">
								...
								<c:choose>
									...
									<c:otherwise>
										<li><a class="active" href="<spring:url value='/user/tenant_wishlist'/>">My Wish List</a></li>
									</c:otherwise>
								</c:choose>
    ...
    <div class="about-box">
		<div class="container">
            ...
            <c:forEach var="v" items="${requestScope.tenant_wishlist}">
		    <div class="row">
				<div class="col-md-6" style="height: 500px; width: 550px;">
					<div id="da-thumbs" class="da-thumbs portfolio">
						<div class="post-media_g pitem item-w1 item-h1 cat2">
	                      <a href="${pageContext.request.contextPath}/${v.propertyId.propertyPic}"  data-rel="prettyPhoto[gal]">   
	                      <img src="${pageContext.request.contextPath}/${v.propertyId.propertyPic}" alt="" class="img-responsive">
	                        <div>
				...
				<div class="col-md-6" style="margin-top: 50px;">
					<div class="message-box right-ab">
		                      <h4><b>Location: </b> ${v.propertyId.area}</h4>
		                      <h3><b>Society Name: </b> ${v.propertyId.societyName}</h3>
		                      <h3><b>Posted By: </b>${v.propertyId.userId.firstName} ${v.propertyId.userId.lastName}</h3>
		                      <h3><b>Posted on: </b>${v.propertyId.createdDate}</h3>
		                      <input type="hidden" name="propertyId" id="propertyId" value="${v.propertyId.id}">
		                      	<%-- <a href="<spring:url value='/property/schedule_appointment?pid=${v.propertyId.id}'/>" 
									class="btn btn-light btn-radius grd1 btn-brd"> Book this property </a> --%>
							  <input style="width: 250px;" type="submit" value="Book this property" id="submit1" class="btn btn-light btn-radius btn-brd grd1 btn-block">
		            </div>
				</div>
				<div class="col-md-6" style="margin-top: 50px;">
					<div class="message-box right-ab">
					<h3> Pay Rs.1000/- for booking this property. This amount will be adjusted in the Government charges that needs to be paid for rent agreement.</h3>
					</div>
				</div>
				<hr class="hr1">
			</div>
