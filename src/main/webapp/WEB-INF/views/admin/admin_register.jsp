                    ...
                    <ul class="nav navbar-nav navbar-right">
                    	<c:choose>
						    <c:when test="${adminDetails.email == null}">
						        ...
						        <li><a class="active" href="<spring:url value='/admin/register'/>">Register</a></li>
						    </c:when>
						    <c:otherwise>
        ...
        function validation(){
           ...
           else  
           {
	        ...
	        else 
            {
                ...
                {
                    document.getElementById('cpasswords').innerHTML=" **Password should be >= 8 digits";
                   return false;
                }
	    	...
	    	{
            	validationsDiv.style.display = "block";
		    	document.getElementById('confirmpwd').innerHTML=" **Password must be same";
                return false;
	    	}   
        }
    </script>
