		    ...
		    <div class="row">
				<div class="col-md-6">
					<div id="da-thumbs" class="da-thumbs portfolio">
						<div class="post-media_g pitem item-w1 item-h1 cat2">
	                      <a href="${pageContext.request.contextPath}/${v.propertyPic}"  data-rel="prettyPhoto[gal]">   
				...
				<div class="col-md-6">
					<div class="message-box right-ab">
		                      <h4><b>Location: </b> ${v.area}</h4>
		                      <h3><b>Society Name: </b> ${v.societyName}</h3>
		                      <h3><b>Additional Info: </b>${v.additionalInfo}</h3>
		                      <h3><b>Bedroom: </b>${v.noOfRooms}</h3>
		                      <h3><b>Property Size: </b>${v.size}</h3>
		                      <h3><b>Furnished Status: </b> ${v.furnishedType}</h3>
							  <h3><b>Parking Type: </b>${v.parkingType}</h3>
							  <h3><b>Property Type: </b>${v.type}</h3>
		                      <h3><b>Posted By: </b>${v.userId.firstName} ${v.userId.lastName}</h3>
		                      <h3><b>Posted on: </b>${v.createdDate}</h3>
		                      <c:choose>
			                      <c:when test="${userDetails.userType == 'tenant'}">
			                      	<a href="<spring:url value='/property/schedule_appointment?pid=${v.id}'/>" 
										class="btn btn-light btn-radius grd1 btn-brd"> Interested </a>
			                      </c:when>
			                      <c:otherwise>
			                      	<h4>Please log in as tenant to show interest in this property !</h4>
			                      </c:otherwise>
		                      </c:choose>
		            </div>
				</div>
